        ...
        <InfoSection>
          ...
          <FancyList>
            {[
              ...
              "Наш сотрудник приедет и произведет замер. После замера подсчитывается точная сумма исходя из данных замера, которая вносится в договор",
              ...
              "Нашим мастером производится установка дверей"
            ]}
          </FancyList>
